...
# gsea_hallmarks_file = file.path(RESULTS_DIR,"files","gsea","Hodis2022-invitro_eng_melanoc-hallmarks.tsv.gz")
# gsea_reactome_file = file.path(RESULTS_DIR,"files","gsea","Hodis2022-invitro_eng_melanoc-reactome.tsv.gz")
